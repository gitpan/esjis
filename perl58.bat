...
Find perl.exe ver.5.8 in the computer order by,
...
It finds, and executes perl5.8 without setting environment variable %PATH%.

This utility is convenient to make perl5.5 coexist with perl5.8.
